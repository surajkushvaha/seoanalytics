...
const Sidebar: React.FC = () => {
  return (
    <div className='col-span-2 bg-[#cce4ff]'>
    <div className="flex flex-col items-center  h-full overflow-hidden text-indigo-300 bg-indigo-900">
      ...
      <div className="w-full px-2">
        <div className="flex flex-col items-center w-full mt-3 border-t border-gray-700">
          ...
          <Link
            className="flex items-center w-full h-12 px-3 mt-2 text-gray-400 bg-indigo-700 rounded"
            href="/insights"
          >
            <svg
              className="w-6 h-6 stroke-current"
